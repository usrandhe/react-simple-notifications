...
```bash
npm install react-toast-notifications-pro
```
...
import { ToastProvider } from 'react-toast-notifications-pro';
import App from './App';
...
```jsx
import React from 'react';
import { useToast } from 'react-toast-notifications-pro';
